...
## Registro 1 - Bola: Verificação de objeto por claim no microsserviço
...
## Registro 2 - Chave destática hardcoded - OAuth2 Client Credentials (M2M)
...
## Registro 3 -JWT exp = 24h -> Access Token 15 min + Refresh Token
...
## Registro 4 - PostgreSQL compartilhado -> Database per Service
...
## Registo 5 - API sem versionamento -> /v1/ + Sunset Policy 6 meses
